...
const LOGOS: { src: string; h: number }[] = [
  { src: "/assets/clientes/trim/cliente-1.webp", h: 80 }, // Coplogistics (recortado)
  { src: "/assets/clientes/trim/cliente-2.webp", h: 92 }, // Aura Andina (tarjeta, +caja)
  { src: "/assets/clientes/trim/cliente-3.webp", h: 96 }, // Ceinys (tarjeta, +caja)
  { src: "/assets/clientes/trim/cliente-4.webp", h: 46 }, // yonda (horizontal)
  { src: "/assets/clientes/trim/cliente-5.webp", h: 92 }, // El Charcutero (tarjeta, +caja)
  { src: "/assets/clientes/trim/cliente-6.webp", h: 84 }, // CGH (recortado)
  { src: "/assets/clientes/trim/cliente-7.webp", h: 46 }, // Changan (horizontal)
  { src: "/assets/clientes/trim/cliente-8.webp", h: 52 }, // Renault (semi-ancho)
  { src: "/assets/clientes/trim/cliente-9.webp", h: 46 }, // Landini (horizontal)
  { src: "/assets/clientes/trim/cliente-10.webp", h: 48 }, // Citroën (horizontal)
  { src: "/assets/clientes/trim/cliente-11.webp", h: 92 }, // Suzuki (tarjeta, +caja)
  { src: "/assets/clientes/trim/cliente-12.webp", h: 90 }, // Mazda (tarjeta, +caja)
  { src: "/assets/clientes/trim/cliente-13.webp", h: 68 }, // Subaru (semi-cuadrado)
  { src: "/assets/clientes/trim/cliente-14.webp", h: 52 }, // JAC (semi-ancho)
  { src: "/assets/clientes/trim/cliente-15.webp", h: 92 }, // El Charcutero oscuro (tarjeta, +caja)
  { src: "/assets/clientes/trim/cliente-16.webp", h: 46 }, // Motorpark (horizontal)
  { src: "/assets/clientes/trim/cliente-17.webp", h: 48 }, // GWM (horizontal)
];
